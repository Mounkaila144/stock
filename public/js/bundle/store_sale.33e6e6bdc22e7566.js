  ...
  methods: {
    ...
    GetElements: function GetElements() {
      ...
      axios.get("sales/create").then(function (response) {
        ...
        if (!_this15.sale.warehouse_id) {
          var _response$data$wareho;
          _this15.sale.warehouse_id = (_response$data$wareho = response.data.warehouses[0]) === null || _response$data$wareho === void 0 ? void 0 : _response$data$wareho.id;
          setTimeout(function () {
            _this15.Selected_Warehouse(_this15.sale.warehouse_id);
          }, 100);
        }
