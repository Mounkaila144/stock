  ...
  methods: {
    ...
    GetElements: function GetElements() {
      ...
      axios.get("purchases/create").then(function (response) {
        ...
        if (!_this10.purchase.warehouse_id) {
          var _response$data$wareho;
          _this10.purchase.warehouse_id = (_response$data$wareho = response.data.warehouses[0]) === null || _response$data$wareho === void 0 ? void 0 : _response$data$wareho.id;
          setTimeout(function () {
            _this10.Selected_Warehouse(_this10.purchase.warehouse_id);
          }, 100);
        }
...
var render = function render() {
  ...
  return _c("div", {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(validationContext) {
        return [_c("b-form-group", {
          ...
          model: {
            value: _vm.purchase.expected_delivery_date,
            callback: function callback($$v) {
              _vm.$set(_vm.purchase, "expected_delivery_date", $$v);
            },
            expression: "purchase.expected_delivery_date"
          }
        }), _vm._v(" "), _c("b-form-invalid-feedback", {
          attrs: {
            id: "date-feedback"
    ...
    }, [_vm._v("+")])])], 1)], 1)]), _vm._v(" "), _c("td", [_vm._v(_vm._s(_vm.currentUser.currency) + " " + _vm._s(_vm.formatNumber(detail.DiscountNet * detail.quantity, 2)) + "\n                        ")]), _vm._v(" "), _c("td", [_vm._v(_vm._s(_vm.currentUser.currency) + " " + _vm._s(_vm.formatNumber(detail.taxe * detail.quantity, 2)))]), _vm._v(" "), _c("td", [_vm._v(_vm._s(_vm.currentUser.currency) + " " + _vm._s(detail.subtotal.toFixed(2)))]), _vm._v(" "), _c("td", [_vm.currentUserPermissions && _vm.currentUserPermissions.includes("edit_product_purchase") ? _c("i", {
