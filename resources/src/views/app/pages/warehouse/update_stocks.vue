<template>
  <div class="main-content">
    <breadcumb :page="$t('Remove.TitleStock')" :folder="$t('ListAdjustments')" />
      ...
      if (this.verifiedForm()) {
        ...
        axios
          ...
          .then(response => {
            ...
            NProgress.done();
            this.adjustment = EmptyAdjustment(this.adjustment);
            this.details = [];
    ...
    Get_Elements() {
      axios
        ...
        .then(response => {
          ...
          if(!this.adjustment.warehouse_id){
            setTimeout(() => {
            this.adjustment.warehouse_id = response.data.warehouses[0]?.id;
            this.Selected_Warehouse(this.adjustment.warehouse_id);
            },100);
          }
