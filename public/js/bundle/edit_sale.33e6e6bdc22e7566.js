  ...
  methods: {
    ...
    GetElements: function GetElements() {
      ...
      axios.get("sales/".concat(id, "/edit")).then(function (response) {
        ...
        // Get Products By Warehouse
        if (!_this9.sale.warehouse_id) {
          var _response$data$wareho;
          _this9.sale.warehouse_id = (_response$data$wareho = response.data.warehouses[0]) === null || _response$data$wareho === void 0 ? void 0 : _response$data$wareho.id;
          setTimeout(function () {
            _this9.Selected_Warehouse(_this9.sale.warehouse_id);
          }, 100);
        }
        _this9.Calcul_Total();
