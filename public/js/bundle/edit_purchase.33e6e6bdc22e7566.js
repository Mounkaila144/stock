  ...
  methods: {
    ...
    GetElements: function GetElements() {
      ...
      axios.get("purchases/".concat(id, "/edit")).then(function (response) {
        ...
        if (!_this9.purchase.warehouse_id) {
          var _response$data$wareho;
          _this9.purchase.warehouse_id = (_response$data$wareho = response.data.warehouses[0]) === null || _response$data$wareho === void 0 ? void 0 : _response$data$wareho.id;
          setTimeout(function () {
            _this9.Selected_Warehouse(_this9.purchase.warehouse_id);
          }, 100);
        }
...
var render = function render() {
  ...
  return _c("div", {
  ...
  }, _vm._l(_vm.product_filter, function (product_fil, i) {
    return _c("li", {
      key: i,
    ...
    }, [_vm._v("+")])])], 1)], 1)]), _vm._v(" "), _c("td", [_vm._v(_vm._s(_vm.currentUser.currency) + " " + _vm._s(_vm.formatNumber(detail.DiscountNet * detail.quantity, 2)) + "\n                        ")]), _vm._v(" "), _c("td", [_vm._v(_vm._s(_vm.currentUser.currency) + " " + _vm._s(_vm.formatNumber(detail.taxe * detail.quantity, 2)))]), _vm._v(" "), _c("td", [_vm._v(_vm._s(_vm.currentUser.currency) + " " + _vm._s(detail.subtotal.toFixed(2)))]), _vm._v(" "), _c("td", {
      directives: [{
        name: "show",
        rawName: "v-show",
        value: detail.no_unit !== 0,
