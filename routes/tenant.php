...
//------------------------------------------------------------------\\
    Route::get('api/etiquettes', [EtiquettesController::class, 'generatePDF']);
    Route::get('api/etiquettes/print/{ids}', [EtiquettesController::class, 'printSelected']);
    Route::get('api/etiquettes/copy_all_codes', [EtiquettesController::class, 'copyAllCodes']);
