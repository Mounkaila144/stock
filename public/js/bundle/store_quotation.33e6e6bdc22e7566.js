...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/quotations/create_freetext_detail.vue?vue&type=script&lang=js&":
/*!**********************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/quotations/create_freetext_detail.vue?vue&type=script&lang=js& ***!
  \**********************************************************************************************************************************************************************************************************************************/
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    handleOk: function handleOk(evt) {
      ...
      // console.log(this.description, this.unitPrice, this.quantity);
...
/* harmony import */ var _create_freetext_detail_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./create_freetext_detail.vue */ "./resources/src/views/app/pages/quotations/create_freetext_detail.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  components: {
    CreateFreetextDetail: _create_freetext_detail_vue__WEBPACK_IMPORTED_MODULE_1__["default"]
  },
  metaInfo: {
  ...
  methods: {
    ...
    SearchProduct: function SearchProduct(result) {
      // console.log("SERCH PRODUCT: ", { result });
      this.product = {};
    ...
    // --------------------- Get Product Details ----------------------\\
    AddUnamed: function AddUnamed(data) {
      var _data$description, _data$unitPrice;
      // console.log("ADD UNNAMED: ", { data });
      this.product = {};
      // if (result.product_type == 'is_service') {
      this.product.quantity = (data === null || data === void 0 ? void 0 : data.quantity) || 1;
      this.product.code = (_data$description = data === null || data === void 0 ? void 0 : data.description) !== null && _data$description !== void 0 ? _data$description : "Free Text"; //result.code;
      this.product.Unit_price = (_data$unitPrice = data === null || data === void 0 ? void 0 : data.unitPrice) !== null && _data$unitPrice !== void 0 ? _data$unitPrice : 0;
      this.product.stock = Infinity;
      // this.product.code = result.code;
      // }
      // else{
      //   this.product.code = result.code;
      ...
      this.product.product_type = 'free_text'; //response.data.product_type;
      this.product.name = '[Edit This]'; //response.data.name;
      this.product.Net_price = 0.0; //response.data.Net_price;
      this.product.Unit_price = 0.0; // response.data.Unit_price;
      this.product.fix_price = 0.0; //response.data.fix_price;
      this.product.taxe = 0.0; //response.data.tax_price;
      this.product.tax_method = 'no_tax'; // response.data.tax_method;
      this.product.tax_percent = 20; //response.data.tax_percent;
      this.product.unitSale = 'na'; // response.data.unitSale;
      // this.product.sale_unit_id = 0 //response.data.sale_unit_id;
      this.product.is_imei = false,
      //response.data.is_imei;
    ...
    GetElements: function GetElements() {
      ...
      axios.get("quotations/create").then(function (response) {
        ...
        if (!_this10.quote.warehouse_id) {
          var _response$data$wareho;
          _this10.quote.warehouse_id = (_response$data$wareho = response.data.warehouses[0]) === null || _response$data$wareho === void 0 ? void 0 : _response$data$wareho.id;
          setTimeout(function () {
            _this10.Selected_Warehouse(_this10.quote.warehouse_id);
          }, 100);
        }
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/quotations/create_freetext_detail.vue?vue&type=template&id=74937fe2&":
/*!*********************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/quotations/create_freetext_detail.vue?vue&type=template&id=74937fe2& ***!
  \*********************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  ...
  return _c("div", {
  ...
  }, [_c("CreateFreetextDetail", {
    on: {
      submit: function submit(data) {
        return _vm.AddUnamed(data);
      }
    }
  })], 1), _vm._v(" "), _c("b-col", {
    attrs: {
    ...
    }, [_vm._v("+")])])], 1)], 1)]), _vm._v(" "), _c("td", [_vm._v(_vm._s(_vm.currentUser.currency) + " " + _vm._s(_vm.formatNumber(detail.DiscountNet * detail.quantity, 2)) + "\n                        ")]), _vm._v(" "), _c("td", [_vm._v(_vm._s(_vm.currentUser.currency) + " " + _vm._s(_vm.formatNumber(detail.taxe * detail.quantity, 2)))]), _vm._v(" "), _c("td", [_vm._v(_vm._s(_vm.currentUser.currency) + " " + _vm._s(detail.subtotal.toFixed(2)))]), _vm._v(" "), _c("td", [_vm.currentUserPermissions && _vm.currentUserPermissions.includes("edit_product_quotation") ? _c("i", {
    ...
    staticClass: "bold"
  }, [_vm._v(_vm._s(_vm.$t("OrderTax")))]), _vm._v(" "), _c("td", [_c("span", [_vm._v(_vm._s(_vm.currentUser.currency) + " " + _vm._s(_vm.quote.TaxNet.toFixed(2)) + " (" + _vm._s(_vm.formatNumber(_vm.quote.tax_rate, 2)) + "\n                          %)")])])]), _vm._v(" "), _c("tr", [_c("td", {
    staticClass: "bold"
...
/***/ "./resources/src/views/app/pages/quotations/create_freetext_detail.vue":
/*!*****************************************************************************!*\
  !*** ./resources/src/views/app/pages/quotations/create_freetext_detail.vue ***!
  \*****************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _create_freetext_detail_vue_vue_type_template_id_74937fe2___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./create_freetext_detail.vue?vue&type=template&id=74937fe2& */ "./resources/src/views/app/pages/quotations/create_freetext_detail.vue?vue&type=template&id=74937fe2&");
/* harmony import */ var _create_freetext_detail_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./create_freetext_detail.vue?vue&type=script&lang=js& */ "./resources/src/views/app/pages/quotations/create_freetext_detail.vue?vue&type=script&lang=js&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _create_freetext_detail_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _create_freetext_detail_vue_vue_type_template_id_74937fe2___WEBPACK_IMPORTED_MODULE_0__.render,
  _create_freetext_detail_vue_vue_type_template_id_74937fe2___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/src/views/app/pages/quotations/create_freetext_detail.vue"
...
/***/ "./resources/src/views/app/pages/quotations/create_freetext_detail.vue?vue&type=script&lang=js&":
/*!******************************************************************************************************!*\
  !*** ./resources/src/views/app/pages/quotations/create_freetext_detail.vue?vue&type=script&lang=js& ***!
  \******************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_create_freetext_detail_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./create_freetext_detail.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/quotations/create_freetext_detail.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_create_freetext_detail_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 
...
/***/ "./resources/src/views/app/pages/quotations/create_freetext_detail.vue?vue&type=template&id=74937fe2&":
/*!************************************************************************************************************!*\
  !*** ./resources/src/views/app/pages/quotations/create_freetext_detail.vue?vue&type=template&id=74937fe2& ***!
  \************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_create_freetext_detail_vue_vue_type_template_id_74937fe2___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_create_freetext_detail_vue_vue_type_template_id_74937fe2___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_create_freetext_detail_vue_vue_type_template_id_74937fe2___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./create_freetext_detail.vue?vue&type=template&id=74937fe2& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/quotations/create_freetext_detail.vue?vue&type=template&id=74937fe2&");
