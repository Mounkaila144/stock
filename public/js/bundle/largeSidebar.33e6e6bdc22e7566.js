...
var render = function render() {
  ...
  return _c("div", {
    ...
    directives: [{
      name: "show",
      rawName: "v-show",
      value: _vm.currentUserPermissions && (_vm.currentUserPermissions.includes("stock_view") || _vm.currentUserPermissions.includes("stock_update")),
      expression: "currentUserPermissions && (currentUserPermissions.includes('stock_view')\n    || currentUserPermissions.includes('stock_update'))"
    }],
    staticClass: "nav-item",
    "class": {
    ...
    staticClass: "nav-item",
    "class": {
      active: _vm.selectedParentMenu == "purchase_shipment"
    },
    attrs: {
    ...
    attrs: {
      tag: "a",
      to: "/app/purchase_shipments"
    }
  }, [_c("i", {
    staticClass: "nav-icon i-Truck"
  }), _vm._v(" "), _c("span", {
    staticClass: "nav-text"
  }, [_vm._v(_vm._s(_vm.$t("purchase_shipments")))])])], 1), _vm._v(" "), _c("li", {
    directives: [{
      name: "show",
      rawName: "v-show",
    ...
    directives: [{
      name: "show",
      rawName: "v-show",
      value: _vm.currentUserPermissions && (_vm.currentUserPermissions.includes("todo_task_view") || _vm.currentUserPermissions.includes("todo_task_add")),
      expression: "currentUserPermissions && (currentUserPermissions.includes('todo_task_view')\n    || currentUserPermissions.includes('todo_task_add'))"
    }],
    staticClass: "nav-item",
    "class": {
      active: _vm.selectedParentMenu == "todo"
    },
    attrs: {
      "data-item": "Todo",
      "data-submenu": true
    ...
    staticClass: "nav-text"
  }, [_vm._v(_vm._s(_vm.$t("Todos")))])]), _vm._v(" "), _c("div", {
    staticClass: "triangle"
    ...
    staticClass: "childNav d-none",
    "class": {
      "d-block": _vm.selectedParentMenu == "Todo"
    },
    attrs: {
      "data-parent": "Todo"
    }
  }, [_vm.currentUserPermissions && _vm.currentUserPermissions.includes("todo_task_view") ? _c("li", {
    staticClass: "nav-item"
  }, [_c("router-link", {
    attrs: {
      tag: "a",
    ...
    staticClass: "item-name"
  }, [_vm._v(_vm._s(_vm.$t("Tasks")))])])], 1) : _vm._e()]), _vm._v(" "), _c("ul", {
    staticClass: "childNav d-none",
    "class": {
  ...
  }, [_vm.currentUserPermissions && _vm.currentUserPermissions.includes("stock_view") ? _c("li", {
    staticClass: "nav-item"
  }, [_c("router-link", {
    attrs: {
      tag: "a",
      to: "/app/Warehouse/StockList"
    }
  }, [_c("i", {
    staticClass: "nav-icon i-Files"
  }), _vm._v(" "), _c("span", {
    staticClass: "item-name"
  }, [_vm._v(_vm._s(_vm.$t("Stock_List")))])])], 1) : _vm._e(), _vm._v(" "), _vm.currentUserPermissions && _vm.currentUserPermissions.includes("stock_update") ? _c("li", {
    staticClass: "nav-item"
  }, [_c("router-link", {
    attrs: {
      tag: "a",
      to: "/app/Warehouse/StockUpdate"
    }
  }, [_c("i", {
    staticClass: "nav-icon i-Remove-File"
  }), _vm._v(" "), _c("span", {
    staticClass: "item-name"
  }, [_vm._v(_vm._s(_vm.$t("Stock_Update")))])])], 1) : _vm._e()]), _vm._v(" "), _c("ul", {
    staticClass: "childNav d-none",
    "class": {
...
var render = function render() {
  ...
  return _c("div", {
    ...
    attrs: {
      src: __webpack_require__(/*! ../../../assets/logo.png */ "./resources/src/assets/logo.png"),
      alt: "",
      width: "60",
      height: "60"
    }
...
module.exports = "/images/logo.png?69fc2f2d95f19f8940dd53407e4d6db2";
