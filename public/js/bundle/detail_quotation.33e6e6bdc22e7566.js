...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    formatNumber: function formatNumber(number, dec) {
      var value = (typeof number === "string" ? number : (number !== null && number !== void 0 ? number : 0).toString()).split(".");
...
var render = function render() {
  ...
  return _c("div", {
    ...
    attrs: {
      href: "/api/quote_pdf/".concat(_vm.$route.params.id),
      target: "_blank"
    }
  }, [_c("i", {
    ...
    staticClass: "bold"
  }, [_vm._v(_vm._s(_vm.$t("OrderTax")))]), _vm._v(" "), _c("td", [_c("span", [_vm._v(_vm._s(_vm.currentUser.currency) + " " + _vm._s(_vm.quote.TaxNet ? _vm.quote.TaxNet.toFixed(2) : "") + " (" + _vm._s(_vm.formatNumber(_vm.quote.tax_rate, 2)) + "\n                      %)")])])]), _vm._v(" "), _c("tr", [_c("td", {
    staticClass: "bold"
  }, [_vm._v(_vm._s(_vm.$t("Discount")))]), _vm._v(" "), _c("td", [_vm._v(_vm._s(_vm.currentUser.currency) + " " + _vm._s(_vm.quote.discount ? _vm.quote.discount.toFixed(2) : ""))])]), _vm._v(" "), _c("tr", [_c("td", {
    staticClass: "bold"
  }, [_vm._v(_vm._s(_vm.$t("Shipping")))]), _vm._v(" "), _c("td", [_vm._v(_vm._s(_vm.currentUser.currency) + " " + _vm._s(_vm.quote.shipping ? _vm.quote.shipping.toFixed(2) : ""))])]), _vm._v(" "), _c("tr", [_c("td", [_c("span", {
    staticClass: "font-weight-bold"
