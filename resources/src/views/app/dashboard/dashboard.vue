    ...
    <div v-else-if="!loading && currentUserPermissions && currentUserPermissions.includes('dashboard')">
        ...
        <div class="col-md-4">
          <div class="card mb-30">
            <div class="card-body p-3">
              <!-- <h5 class="card-title border-bottom p-3 mb-2">{{ $t('Top_Selling_Products') }} ({{ CurrentMonth }})</h5> -->
              <h5 class="card-title border-bottom p-3 mb-2">{{ $t('Top_Purchased_Products') }} ({{ CurrentMonth }})</h5>

              <vue-good-table :columns="columns_products" styleClass="order-table vgt-table" row-style-class="text-left"
                :rows="products">
                <template slot="table-row" slot-scope="props">
          ...
          <router-link tag="a" class to="/app/sales/list">
            <b-card class="card-icon-bg card-icon-bg-primary o-hidden mb-30 text-center">
              ...
              <div class="content">
                ...
                <p class="text-primary text-24 line-height-1 mb-2">{{ currentUser.currency }}
      ...
      <b-row>
        ...
        <b-col col lg="4" md="12" sm="12">
          <b-card class="mb-30">
            <h4 class="card-title m-0">{{ $t('Top_Purchased_Products') }} ({{ new Date().getFullYear() }})</h4>
            <div class="chart-wrapper">
              <div v-once class="typo__p text-right" v-if="loading">
                <div class="spinner sm spinner-primary mt-3"></div>
              </div>
...
import StockAlert from "./stock_alert.vue";
      ...
      axios
        ...
        .then(response => {
          ...
          this.echartProduct = {
            ...
            formatter: function (params) {
              return `${params.name}: (${params.value} ${_this.$t('Purchases')})`;
            },
            series: [
              {
                name: this.$t('Top_Purchased_Products'),
                type: "pie",
                radius: "50%",
                center: "50%",
